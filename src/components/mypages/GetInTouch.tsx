...
const GetInTouch = () => {
  return (
    <div className=" mx-4 md:mx-16 lg:mx-82 text-lg md:text-[20px] pt-6">
      <div className="pt-6 mt-10 flex flex-row justify-center">
        <TextRevealCard
          text="You know the business"
          revealText="I know the chemistry"
          className="flex flex-col justify-center w-full max-w-md sm:max-w-xl"
        >
          <TextRevealCardTitle className=" font-bold text-lg md:text-[20px]">
            Work Together?
          </TextRevealCardTitle>
        </TextRevealCard>
      </div>
